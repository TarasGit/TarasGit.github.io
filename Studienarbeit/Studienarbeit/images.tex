...
\documentclass[a4paper,left=1.9cm,right=2.1cm,top=1.2cm,bottom=2.3cm]{article}
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap751}%
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlfigureA{lstlisting120}%
\begin{lstlisting}%[caption=user space s3c-udc configuration]
\par
else if
